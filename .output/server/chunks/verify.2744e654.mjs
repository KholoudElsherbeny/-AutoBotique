...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "h-100 verify_page" }, _attrs))} data-v-f6009662><div class="h-100 auth_form_container d-flex justify-content-start align-items-center" data-v-f6009662><div class="container-fluid w-100" data-v-f6009662><div class="row" data-v-f6009662>`);
      _push(ssrRenderComponent(_component_VForm, {
        ...
        default: withCtx(({ meta: formMeta }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="d-flex flex-column gap-3" data-v-f6009662${_scopeId}><h5 class="sub_title" data-v-f6009662${_scopeId}>${ssrInterpolate(_ctx.$t("auth_sub_title"))}</h5><h1 class="title" data-v-f6009662${_scopeId}>Verifying Account</h1><div class="w-75 mb-4" data-v-f6009662${_scopeId}> We just sent a 4-digit verification to +${ssrInterpolate(unref(phone_code))} ${ssrInterpolate(unref(phone))}. enter the code in the box below to continue. </div>`);
            ...
            _push2(`<div class="d-flex justify-content-between" data-v-f6009662${_scopeId}><div data-v-f6009662${_scopeId}> Didn&#39;t Receive A Code?<button${ssrIncludeBooleanAttr(unref(timerCount)) ? " disabled" : ""} class="${ssrRenderClass([unref(timerCount) && "btn_disabled", "mainColor span_btn"])}" data-v-f6009662${_scopeId}> Resend </button></div><div data-v-f6009662${_scopeId}>${ssrInterpolate("0 : " + unref(timerCount))}</div></div><div class="d-flex justify-content-end mt-3" data-v-f6009662${_scopeId}>`);
      ...
      _push(`</div></div></div><img${ssrRenderAttrs(mergeProps({
        ...
        "data-src": _imports_0,
        alt: "car"
      }, ssrGetDirectiveProps(_ctx, _directive_lazy_load)))} data-v-f6009662></section>`);
    };
  }
};
...
const verify = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f6009662"]]);

export { verify as default };
//# sourceMappingURL=verify.2744e654.mjs.map
